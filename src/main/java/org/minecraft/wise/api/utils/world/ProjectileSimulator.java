 ...
 * @author bleachhack
 */
public class ProjectileSimulator implements IMinecraft {
...
//                return e;
//            }
        if (hand.getItem() instanceof SnowballItem || hand.getItem() instanceof EggItem || hand.getItem() instanceof EnderPearlItem) {
