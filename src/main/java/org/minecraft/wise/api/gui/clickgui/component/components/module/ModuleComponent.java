package org.minecraft.wise.api.gui.clickgui.component.components.module;
...
import org.minecraft.wise.api.gui.clickgui.component.components.settings.*;
...
public final class ModuleComponent implements IMinecraft, Component {
    ...
    public void drawScreen(DrawContext context, int mouseX, int mouseY, float partialTicks) {
        Color disabled = new Color(25 / 255.0F, 25 / 255.0F, 25 / 255.0F, ClientGuiPort.getInstance().getColorTransparency() / 255.0F);
...
//        }
        ...
        FontManager.drawText(context, this.module.getName(), (int) (this.parent.getX() + 4), (int) (this.y + 4), ColorUtil.getRGBA(textColor));
