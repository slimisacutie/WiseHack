...
public final class BindComponent extends SettingComponent<Bind> {
    ...
    public void drawScreen(DrawContext context, int mouseX, int mouseY, float partialTicks) {
        ...
        Color valueColor = new Color(120 / 255.0F, 120 / 255.0F, 120 / 255.0F, HudGuiPort.getInstance().getColorTransparency() / 255.0F);
        if (this.binding) {
            FontManager.drawText(context, "Listening...", (int) (this.getX() + 3.0F), (int) (this.getY() + 4.0F), ColorUtil.getRGBA(valueColor));
        } else {
